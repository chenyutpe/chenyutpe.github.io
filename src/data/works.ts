...
export const featuredWorks: WorkItem[] = [
  {
    ...
    description: "Motivated by diminished natural sounds in cities, we explored augmenting soundscapes to help people notice both missing and existing urban nature.",
  ...
  },
  {
    ...
    authors: "Yu Chen",
    description: "An interactive web app that lets concert audiences create soundscapes with Taiwanese birdsongs by arranging bird stickers on a virtual island. Featured at three live events alongside bird flute and whistle performances.",
